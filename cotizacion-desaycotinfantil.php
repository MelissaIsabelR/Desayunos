...
<br><br>
    ...
    <table id="tablaBebida" border='2'>
      <tr>
        <td colspan=2>BEBIDA INFANTIL</td>
    ...
    <table id="tablaDulces" border='2'>
      <tr>
        <td colspan=2>DULCES INFANTIL</td>
        <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg-dulces">+</button></td>
      </tr>
        <tr>
        <th>MODELO</th>
        <th>OPCIONES</th>
    ...
    <table id="tablaLacteos" border='2'>
      <tr>
        <td colspan=2>LACTEOS INFANTIL</td>
        <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg-lacteos">+</button></td>
      </tr>
        <tr>
        <th>MODELO</th>
        <th>OPCIONES</th>
    ...
    <table id="tablaAcompanamiento" border='2'>
      <tr>
        <td colspan=2>ACOMPAÑAMIENTO INFANTIL</td>
...
<div class="modal fade bs-example-modal-lg-dulces" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close add" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      ...
      <div class="modal-body">
        <div class="row">
         ...
         <button type="button" class="btn btn-primary addDulces" >1</button>
         <button type="button" class="btn btn-primary addDulces" >2</button>
         <button type="button" class="btn btn-primary addDulces" >3</button>
         <button type="button" class="btn btn-primary addDulces" >4</button>
         </div>
...
<div class="modal fade bs-example-modal-lg-lacteos" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close add" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      ...
      <div class="modal-body">
        <div class="row">
         ...
         <button type="button" class="btn btn-primary addLacteos" >1</button>
         <button type="button" class="btn btn-primary addLacteos" >2</button>
         <button type="button" class="btn btn-primary addLacteos" >3</button>
         <button type="button" class="btn btn-primary addLacteos" >4</button>
         </div>
...
idLacteosGenerado=0;
$('.addLacteos').click(function () {
    idLacteosGenerado=idLacteosGenerado+1;
    $('#tablaLacteos').append('<tr id="filaLacteos'+idLacteosGenerado+'"><td>'+idLacteosGenerado+'</td><td><button id="boton-Lacteos'+idLacteosGenerado+'"" onclick="EliminarFila(this.id)">-</button></td></tr>');
});

idDulcesGenerado=0;
$('.addDulces').click(function () {
    idDulcesGenerado=idDulcesGenerado+1;
    $('#tablaDulces').append('<tr id="filaDulces'+idDulcesGenerado+'"><td>'+idDulcesGenerado+'</td><td><button id="boton-Dulces'+idDulcesGenerado+'"" onclick="EliminarFila(this.id)">-</button></td></tr>');
});
